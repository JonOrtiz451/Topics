...
//This is a subclass called Square with its own unique characteristics, itinherits from Shape
class Square : Shape
{
    private double side1;
    private double side2;
    public Square() { }//empty constructor
    public Square(double side1, double side2)//overloading, we will passing a length & width(we'll use this to populate with data)
{
        this.side1 = side1;
        this.side2 = side2;
    }
