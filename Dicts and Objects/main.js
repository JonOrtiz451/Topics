...
var number56 = 4;
// CODE HERE:
console.log("I catch the value: " + myArray[4]);
...
var number16 = 4;
// CODE HERE:
console.log("I catch the value: " + matrix[1][2]);
...
var tempAge = 4;
// CODE HERE:
console.log("I catch the value: " + human["Age"]);
...
Example:
var BravesTeam = arrayOfTeams[4];
var teamName = BravesTeam["name"];
var city = BravesTeam["City"];
var founded = BravesTeam["Founded"];
...
// CODE HERE:
var stringToPrint = ("The " + team4["name"] + " team were founded in " + team4["Founded"] + ". This team is from " +
    team4["City"]);
...
var theTeams = macroObject["arrayOfTeams"];
var packersTeam = theTeams[1];
var nameOfTeam = packersTeam["name"];
var yearFoundation = packersTeam["Founded"];
var stringToPrint = "The "  + nameOfTeam + " were founded in " + yearFoundation;
var stringtoPrint = (macroObject);
console.log(stringToPrint);
